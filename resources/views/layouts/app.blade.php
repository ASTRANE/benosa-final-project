...
<head>
    ...
    <title>@yield('title', 'BenoCare') — BenoCare</title>
...
@auth
<div id="sidebar">
    <div class="brand"><i class="bi bi-heart-pulse-fill"></i> BenoCare</div>
...
<div id="main">
    <div id="topbar" class="d-flex align-items-center justify-content-between">
        ...
        <div class="d-flex align-items-center gap-2">
            @if(Auth::user()->avatar)
                <img src="{{ Auth::user()->avatar }}" class="rounded-circle" width="32" height="32" style="object-fit:cover">
            @else
