...
<div class="d-flex align-items-center gap-2 mb-3">
    ...
    <h5 class="fw-bold mb-0" style="color:#2E7D32;">Edit Patient — {{ $patient->name }}</h5>
</div>
...
<div class="card stat-card p-4" style="max-width:720px;">
    ...
    <form method="POST" action="{{ route('patients.update', $patient) }}">
        ...
        <div class="d-flex gap-2 mt-4">
            <button type="submit" class="btn btn-primary px-4"><i class="bi bi-check-lg me-1"></i> Update Patient</button>
